...
function LoginForm({ toggleLogin }) {
    ...
    return (<div id="authentication-modal" tabindex="-1"
        ...
        class=" top-0 left-0 right-0 z-10 flex  absolute backdrop-blur-sm justify-center w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] md:h-full">
        <div class="h-fit w-xl z-20 bg-slate-800 rounded-lg"  >
            <div class="relative" onClick={() => null}>
                <button onClick={() => toggleLogin()} type="button" class="absolute top-3 right-2.5 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-800 dark:hover:text-white" data-modal-hide="authentication-modal">
                ...
                <div class="px-6 py-6 lg:px-8">
                    ...
                    <form class="space-y-6" onSubmit={async (e) => {
                        ...
                        <div>
                            ...
                            <input type="text" name="username" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" placeholder="admin" onChange={e => setUsername(e.target.value)} value={username} required />
                        </div>
                        <div>
