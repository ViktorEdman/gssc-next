...
function LoginForm({ toggleLogin }) {
    ...
    return (<div id="authentication-modal" tabindex="-1"
        ...
        class=" top-0 left-0 right-0 z-10 flex  absolute bg-black/50 justify-center w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] md:h-full">
